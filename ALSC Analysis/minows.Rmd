...
for(i in 1:length(group)){
  species=na.omit(lakes$LAB_PH[which(lakes[,fish[i]] != 0)])
...
for(i in 1:length(group)){
  species=na.omit(lakes$Volume.m3.[which(lakes[,fish[i]] != 0)])
  for(x in 1:length(species)){
...
for(i in 1:length(group)){
  species=na.omit(lakes$lakes$SIO2..mg.L.1.[which(lakes[,fish[i]] != 0)])
  for(x in 1:length(species)){
...
for(i in 1:length(group)){
  species=na.omit(lakes$Ca..mg.L.1.[which(lakes[,fish[i]] != 0)])
  for(x in 1:length(species)){
